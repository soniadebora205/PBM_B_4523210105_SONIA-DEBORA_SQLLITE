...
class EditMahasiswa extends StatefulWidget {
  ...
  const EditMahasiswa({Key? key, required this.student}) : super(key: key);
...
class _EditMahasiswaState extends State<EditMahasiswa> {
  ...
  late TextEditingController _nameCtrl, _ttlCtrl, _jenisCtrl,
      _alamatCtrl, _agamaCtrl, _pendidikanCtrl, _noHpCtrl, _emailCtrl;
  ...
  void initState() {
    ...
    _ttlCtrl        = TextEditingController(text: s['ttl'] ?? '');
    _jenisCtrl      = TextEditingController(text: s['jenis_kelamin'] ?? '');
    _alamatCtrl     = TextEditingController(text: s['alamat'] ?? '');
    _agamaCtrl      = TextEditingController(text: s['agama'] ?? '');
    _pendidikanCtrl = TextEditingController(text: s['major'] ?? '');
    _noHpCtrl       = TextEditingController(text: s['no_hp'] ?? '');
